...
# Ask second question
ans_two = input("Let's see if you're good at math. What is 6 * (4 - 2) / 2^2").lower()
...
if ans_two == "3" or ans_two == "three":
    ...
    print(
        "Hmmmmm, I'm not too sure about that one. The answer key has a different answer. Maybe you should stick to programming.")

# Ask third question
ans_three = input(
    "Now, let's see if you payed attention during science class\nWhat is the sixth planet furthest from the Sun?").lower()
...
# Ask fourth question
ans_four = input("History time! What year was Canada established?").lower()
